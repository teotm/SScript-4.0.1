# SScript **(Discontinued)**
SScript is **(now discontinued)** a project made to extend HScript and make it eaiser to use. It supports almost all of the Haxe structures.
